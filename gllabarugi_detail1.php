...
if (isset($_POST["action"])) {
    if (isset($_POST['tgl1'])) {
        ...
        while ($rescetakRL = mysqli_fetch_array($qrycetakRL)) {
            ...
            $sqlglmas = "SELECT * FROM glmas$thn WHERE  norek  = '" . $norek1 . "' ORDER BY norek";
        ...
        $sqlupA = "UPDATE labarugi SET saldo01a = '" . $tb997a . "',saldo02a = '" . $tb997b . "' WHERE nourut1 = 'B997'";
        $qryupA = mysqli_query($conn1, $sqlupA);
        ...
        if ($bln == '01') {
            $sqlupK = "UPDATE labarugi SET saldo01a = '" . (($lb1a / $s1a) * 100) . "',saldo02a = '" .  (($s1b / $s1b) * 100)  . "' WHERE nourut1 = 'K999'";
        } else {
            $sqlupK = "UPDATE labarugi SET saldo01a = '" . (($lb1a / $s1a) * 100) . "',saldo02a = '" .  (($lb1b / $s1b) * 100)  . "' WHERE nourut1 = 'K999'";
        }
...
?>
        <div id="section-to-print">
            ...
            <section id="body-of-report">
                <?php include("gllabarugi_print1.php"); ?>
            </section>
            <div class="modal-footer">
                <a href="gllabarugi_cetak1.php?tgl1=<?php echo trim($_REQUEST['tgl1']); ?>" target="_blank" class="btn btn-danger waves-effect btn-sm"><i class="fas fa-print"></i> Cetak</a>
